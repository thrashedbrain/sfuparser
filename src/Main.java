            ...
            try{
                ...
                String Day = "";
                    ...
                    for (int i = 0; i < Rows.size(); i++){
                        ...
                        if (chetweek){
                            if (cols.size() < 4){ 
                                Stringvar = cols.get(2).select("b").text() + cols.get(2).ownText();
                                System.out.print("     ");
                                ...
                                System.out.print("            ");
                                System.out.print(cols.get(2).select("a").text()); //преподаватель и аудитория
                                System.out.print("\n");
                                continue;}
                            ...
                            System.out.print("            ");
                            System.out.print(cols.get(3).select("a").text()); //преподаватель и аудитория
                            System.out.print("\n");
